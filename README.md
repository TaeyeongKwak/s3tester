...
# 개발 버전 설치
git clone https://github.com/s3tester/s3tester.git
cd s3tester
pip install -e .
```
...
전체 목록: `s3tester list operations`
...
- **이슈 트래커**: [GitHub Issues](https://github.com/s3tester/s3tester/issues)
- **토론**: [GitHub Discussions](https://github.com/s3tester/s3tester/discussions)
